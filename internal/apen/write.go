...
// media. It is preservation-first: the header and compressed frames are copied
// verbatim and only the tail is rebuilt - the APEv2 tag from the edited model
// (unknown and non-text items kept, with their flags), then any legacy ID3v1 exactly
// as it was found.
//
// The write itself is [ape.PlanTrailingWrite], shared with the other containers whose
// metadata is a trailing APEv2 tag.
